...
def generate(result: Dict[str, Any], output_path: str) -> None:
    ...
    for name, data in scores.items():
        ...
        color = "#4caf50" if score and score >= 80 else "#ff9800" if score and score >= 50 else "#f44336"
    ...
    for pname, pdata in plugins.items():
        ...
        status_color = "#4caf50" if status == "ok" else "#f44336" if status == "error" else "#9e9e9e"
        plugin_html += f"""
